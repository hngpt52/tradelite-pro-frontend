  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-black rounded-xl p-5 shadow-md border border-white/5 hover:border-white/10 transition-all duration-300 lg:col-span-1">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-[#0f0f0f] border border-white/10 rounded-xl px-3 py-2 focus:outline-none focus:ring-1 focus:ring-white/20 transition-all"
              >
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-green-500">+20.3%</span>
                </div>
                <div className="flex justify-between">
        ...
        {/* Chart and Analysis */}
        <div className="bg-black rounded-xl p-5 shadow-md border border-white/5 hover:border-white/10 transition-all duration-300 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold">{symbol} Price Chart</h2>
            <div className="flex space-x-2">
              <button className="bg-[#0f0f0f] hover:bg-white/5 px-3 py-1 rounded-lg text-sm transition-colors">
                1M
              </button>
              <button className="bg-white text-black px-3 py-1 rounded-lg text-sm">3M</button>
              <button className="bg-[#0f0f0f] hover:bg-white/5 px-3 py-1 rounded-lg text-sm transition-colors">
                6M
              </button>
              <button className="bg-[#0f0f0f] hover:bg-white/5 px-3 py-1 rounded-lg text-sm transition-colors">
          ...
          <div className="h-64 w-full mb-6 bg-[#0f0f0f] rounded-xl p-4 border border-white/5">
            <div className="h-full w-full flex items-end space-x-1 relative">
              {chartData.prices.map((price, index) => {
                ...
                return (
                  <div key={index} className="flex-1 flex flex-col items-center justify-end h-full">
                    <div
                      className="w-full bg-white/20 rounded-sm transition-all duration-300 hover:bg-white/30"
                      style={{ height: `${height}%` }}
                    ></div>
                  </div>
                )
              ...
              <div className="absolute inset-0 flex items-end">
                <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                  <path
                    d={`M0,${100 - (chartData.prices[0] / Math.max(...chartData.prices)) * 100} ${chartData.prices
                      .map((price, i) => {
              ...
              {showResults &&
                chartData.signals.map((signal, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`absolute w-3 h-3 rounded-full ${signal.type === "buy" ? "bg-green-500" : "bg-red-500"} transition-transform duration-300 hover:scale-125`}
                      style={{
                        left: `${xPos}%`,
                        bottom: `${yPos}%`,
          ...
          {showResults && (
            <div className="border-t border-white/10 pt-4">
              ...
              <p className="text-gray-300">
                The MACD Crossover strategy performed well on AAPL over this period, with 3 winning trades and 1 losing
                trade. The strategy effectively captured the uptrend in June-September, but had a false signal in April.
                Consider adjusting the MACD parameters to reduce false signals in sideways markets.
              </p>

              <div className="mt-4 bg-white/5 rounded-xl p-4 border border-white/10">
                <h4 className="text-sm font-medium mb-1 text-white">Learning Opportunity</h4>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  ...
                  <td className="py-3">
                    <span className="inline-block px-2 py-1 rounded-full text-xs bg-green-500/20 text-green-500">
                      Buy
                    </span>
                  </td>
                ...
                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  ...
                  <td className="py-3">
                    <span className="inline-block px-2 py-1 rounded-full text-xs bg-red-500/20 text-red-500">Sell</span>
                  </td>
                  <td className="py-3">$145.00</td>
                  <td className="py-3 text-red-500">-6.45%</td>
                ...
                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  ...
                  <td className="py-3 text-green-500">+1.18%</td>
                  <td className="py-3 text-sm text-gray-400">MACD line crossed below signal line</td>
                </tr>
              </tbody>
            </table>
